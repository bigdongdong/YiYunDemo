...
//    public static int PLAY_STYLE_GO_AND_BACK = 1;//往返
    public static int PLAY_STYLE_JUST_GO = 2;//无限顺延
    public static int PLAY_STYLE_JUST_ONCE = 3;//只播放一遍，播放完停留在最后一个
    ...
    private Banner(Activity context , Builder builder) {
        super(context);
       ...
       /*设置底部的点点点指示栏*/
        if(builder.isDisplayPoints == true && builder.banners.size()>1){
            ...
            PointsView pv = new PointsView(context , builder.pointsOptions);
    ...
    public static class Builder{
        ...
        public Builder banners(List banners){
