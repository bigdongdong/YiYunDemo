...
public abstract class BottomTabView extends LinearLayout {
    ...
    public BottomTabView(Activity context) {
        super(context);
    ...
    private TabImageButton generateImageButton(){
        return generateImageButton(Color.parseColor("#FFFFFF"));
    }
    ...
    private TabImageButton generateImageButton(int color){
        ...
        imageButton.setLayoutParams(new LayoutParams(imageButtonWidth,
